...
Maintainer host scenarios were observed 2026-07-12. The 0.2.0 release candidate was verified again on 2026-07-15 by the full local release gate and the merged-main CI matrix. This record is compatibility evidence, not independent adoption, a user count, or an outcome-verified market case.
...
| Ephemeral Alpine Linux x64 container | official `node:20-alpine`, Node 20.20.2 | historical pre-release English text policy, 314-test suite, version/help smoke, quick reconciliation | pass; 5 platform-specific skips |
| Intel macOS 26.2 host | official Node 20.20.2 Darwin x64 archive in a temporary directory | historical pre-release published SHA-256 verification, 314-test suite, version/help smoke, quick reconciliation | pass; 5 platform-specific skips |
