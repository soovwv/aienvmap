...
- Shared-server inspection: `reconcile --inspect-home` accepts one explicit readable absolute home, isolates invoking-user environment variables and PATH, scans bounded known roots, and keeps paths redacted; it never recursively enumerates arbitrary homes.
