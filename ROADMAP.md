...
- Next package-manager coverage: add pnpm, Yarn/Corepack, standalone pip/uv/pipx entry-point conflicts, Conda, and manager-native ownership proof without adding runtime dependencies.
