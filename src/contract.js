  ...
  return {
    ...
    outputs: {
      ...
      reconcile: {
        ...
        aiDecisionFields: ["consumer", "decision", "readFirst", "canonicalCandidates", "actionCandidates", "runtimeLinkSummary", "pythonInstallerEvidence", "pythonManagerEvidence", "javaManagerEvidence", "safeCommands", "rules"],
